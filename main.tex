...
%\DeclareFieldFormat{journal}{\href{\thefield{url}}{#1}}
 % Use the bibtex backend with the authoryear citation style (which resembles APA)
%\addbibresource{resources.bib} % The filename of the bibliography

%\usepackage[autostyle=true]{csquotes} % Required to generate language-dependent quotes in the bibliography

\usepackage[backend=biber,style=nature,sorting=none,isbn=false, citestyle=numeric-comp, doi=false, url=false, date=year]{biblatex}
...
\newcommand{\psibarhat}[0]{\bar{\hat{\psi}}}
