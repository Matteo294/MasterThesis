...
We then consider a simulation with a regularised noise defined by a cutoff $\Lambda \leq \Lambda$ and we define a dimensionless parameter
\begin{equation}
...
The use of coloured noise, allows for a smooth interpolation between the fully classical and fully quantum picture. In fact, one can perform various simulations changing the value of the cutoff fraction $s$ and adding/removing quantum degrees of freedom, as pictured in figure \textcolor{red}{add figure}. This can be used either to investigate the role 
...
Noise-induced transition is a well known field of stochastic dynamics \textcolor{red}{citations} and consists in investigating
