...
There are only two exceptions for this, either the correlation length is zero, or infinite. In the latter case the system exhibits scale invariance and it is a fixed point of the RG. \\
